...
import com.flaviomacedo.cursomc.domain.Pagamento;
import com.flaviomacedo.cursomc.domain.PagamentoComBoleto;
import com.flaviomacedo.cursomc.domain.PagamentoComCartao;
import com.flaviomacedo.cursomc.domain.Pedido;
import com.flaviomacedo.cursomc.domain.Produto;
...
import com.flaviomacedo.cursomc.repositories.EstadoRepository;
...
import com.flaviomacedo.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {	
		...
		Cliente cliente1 = new Cliente(null, "Maria Silva", "fhenrique609@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, passwordEncoder.encode("1234"));
		cliente1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cliente2 = new Cliente(null, "Ana Costa", "isaiasmacedocontador@gmail.com", "44497616002", TipoCliente.PESSOAFISICA, passwordEncoder.encode("1234"));
		cliente2.getTelefones().addAll(Arrays.asList("93883321", "3425625"));
		...
		Endereco endereco2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cliente1,
				cidade2);
		Endereco endereco3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "281777012", cliente2,
				cidade2);
